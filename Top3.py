...
class HorseRacingPredictor:
    ...
    def engineer_features(self, df):
        ...
        # Features de position relative ADAPTATIVES - CORRECTION
        features_df['draw_position_ratio'] = features_df['draw_numeric'] / n_runners
        
        # Correction: créer des Series pandas correctement
...
def prepare_features_ml(df, predictor):
    ...
    if 'Poids' in df.columns:
        ...
        df['weight_kg'] = 60.0
        print("⚠️ Colonne 'Poids' non trouvée")
...
def analyze_race_adaptive(df, race_type="AUTO"):
    ...
    config = {
        "PLAT": {"w_odds": 0.5, "w_draw": 0.3, "w_weight": 0.2, "use_weight_analysis": True},
        "ATTELE_AUTOSTART": {"w_odds": 0.7, "w_draw": 0.25, "w_weight": 0.05, "use_weight_analysis": False},
        "ATTELE_VOLTE": {"w_odds": 0.85, "w_draw": 0.05, "w_weight": 0.1, "use_weight_analysis": False}
    }.get(race_type, {"w_odds": 0.6, "w_draw": 0.3, "w_weight": 0.1, "use_weight_analysis": True})
